                                    ...
                                    <div class="col-md-5 mr-auto">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Name2" type="text" class="form-control" placeholder="Nombre">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <img src="https://image.flaticon.com/icons/svg/138/138672.svg" alt="Sports Time" width=30 height=30 hspace="13">
                                                <input id="Lastname2" type="text" class="form-control" placeholder="Apellido">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Identification_Card2" type="text" class="form-control" placeholder="Cédula">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Genre2" type="text" class="form-control" placeholder="Género">
                                            </div>
                                        </div>   
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Born_Date2" type="text" class="form-control" placeholder="Fecha de nacimiento (dd/mm/aaaa)">
                                            </div>
                                        </div>    
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Height2" type="text" class="form-control" placeholder="Altura">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="weight2" type="text" class="form-control" placeholder="Peso">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Category2" type="text" class="form-control" placeholder="Categoría">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Cellphone2" type="text" class="form-control" placeholder="Teléfono">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Eps2" type="text" class="form-control" placeholder="EPS">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Emergency_Number2" type="text" class="form-control" placeholder="Número de emergencia">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Allergies2" type="text" class="form-control" placeholder="Alergias">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Diseases2" type="text" class="form-control" placeholder="Enfermedades">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="Password21" type="password" placeholder="Contraseña" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" id="Coach1" name="OS">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" id="jornada" name="OS">
                                                    <%
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-radio form-check-inline">
                                                <label class="form-check-label">
                                                    ...
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="Role1" onClick="value = 1" value="Role_Entrenador" > Entrenador
                                                    <span class="circle">
                                            ...
                                            <div class="form-check form-check-radio form-check-inline">
                                                <label class="form-check-label">  
                                                    ...
                                                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="Role2" onClick="value = 2" value="Role_Deportista"> Deportista
                                                    <span class="circle">
                                                        <span class="check"></span>
                                                    </span>
                                                </label>

                        ...
                        <div class="col-md-10 ml-auto mr-auto">
                            <div class="card card-signup">
                                ...
                                <center>
                                    <div class="profile">
                                        <div class="avatar">
                                            <img src="assets/img/kit/prof.jpg" alt="Circle Image" class="img-raised rounded-circle img-fluid"  width=200 height=200>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 mr-auto">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <%
                                                        out.println("<p><b>Categoría: </b>" + crr.findAll().get(identifiquer).getCategory() + "</p>");
                                                    %>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <%
                                                        out.println("<p><b>Teléfono: </b>" + crr.findAll().get(identifiquer).getCellphone() + "</p>");
                                                    %>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <%
                                                        out.println("<p><b>Número de emergencia: </b>" + crr.findAll().get(identifiquer).getEmergency_Number() + "</p>");
                                                    %>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <%
                                                        out.println("<p><b>Descripción: </b>" + crr.findAll().get(identifiquer).getDescription() + "</p>");
                                                    %>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-5 mr-auto">
                                            ...
                                            <br><h3 class="card-title text-center">Gestión:</h3><br>
                                            <div class="form-group">
                                                <div class="form-check form-check-radio form-check-inline">
                                                    <h6>Tomar Asistencia:</h6>
                                                    <a tabindex="0" class="button" role="button" data-toggle="popover" data-trigger="focus" title="PARA TOMAR LISTA:" data-content="Selecciona la jornada y presiona el botón LISTA."><img title="ayuda" src="https://image.flaticon.com/icons/svg/148/148769.svg" alt="Sports Time" width=17 height=17 hspace="10"></a>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check form-check-radio form-check-inline">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check form-check-radio form-check-inline">
                                                    <h6>Gestión de entrenamiento:</h6>
                                                    <a tabindex="0" class="button" role="button" data-toggle="popover" data-trigger="focus" title="PARA INICIAR UN ENTRENAMIENTO:" data-content="Presiona el botón ENTRENAMIENTO."><img title="ayuda" src="https://image.flaticon.com/icons/svg/148/148769.svg" alt="Sports Time" width=17 height=17 hspace="10"></a>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="card-footer justify-content-center">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check form-check-radio form-check-inline">
                                                    <h6>Ver gráficas de entrenamiento:</h6>
                                                    <a tabindex="0" class="button" role="button" data-toggle="popover" data-trigger="focus" title="PARA VER LAS GRÁFICAS DE RENDIMIENTO:" data-content="Presiona el botón ENTRENAMIENTO."><img title="ayuda" src="https://image.flaticon.com/icons/svg/148/148769.svg" alt="Sports Time" width=17 height=17 hspace="10"></a>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="card-footer justify-content-center">
                                                    <input id="GraficaEnt" type="submit" value="Gráficas" class="btn btn-info btn-round">
                                                </div>
                                            </div>
